...
namespace PassManaAlpha.MVVM.ViewModel
{
    public class PasswordViewModel : ForkObject
    {
        ...
        public string MasterKey { get; set; } = "deliciouslolis"; //Don't hardcode this! or whatever its not like it matters since this is just a demo, but in a real app you should ask the user for a master key and never store it in plaintext like this. anyway did you watch JJK S3 Part 1?
